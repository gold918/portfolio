            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <a href="{{ route('admin.cta.create') }}" class="btn btn-success">Добавить</a>
                    </div>
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        @if(isset($actions) && is_object($actions))
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(isset($row->id))
                                    <a href="{{ route('admin.cta.edit', ['id' => $row->id]) }}" class="fa fa-pencil"></a>
                                    {{ Form::open(['route' => ['admin.cta.delete', $row->id], 'method'=>'delete', 'class' => 'delete']) }}
