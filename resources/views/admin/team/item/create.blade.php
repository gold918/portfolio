    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                {{ Form::open(['route' => ['admin.team.item.store', $singleId]]) }}
                <div class="box-body">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">Название социальной сети</label>
                ...
                <div class="box-footer">
                    <a class="btn btn-default" href="{{ route('admin.team.single', ['id' => $singleId]) }}">Назад</a>
